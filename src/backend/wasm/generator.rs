...
impl Generator {
    pub fn generate_code(self, program: &Program) -> Result<String, WasmError> {
    ...
    pub fn get_functions(&self, program: &Program) -> Result<Vec<Element>, WasmError> {
    ...
    pub fn get_setup(&self, program: &Program) -> Result<Element, WasmError> {
